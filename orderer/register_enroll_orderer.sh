...
orderer0MSP() {
  ...
  mkdir ${PWD}/consortium/crypto-config-ca/ordererOrganizations/amit.com/orderers/orderer0.amit.com/msp/tlscacerts
  ...
  mkdir ${PWD}/consortium/crypto-config-ca/ordererOrganizations/amit.com/msp/tlscacerts
...
orderer1MSP() {
  ...
  cp ${PWD}/consortium/crypto-config-ca/ordererOrganizations/amit.com/msp/config.yaml ${PWD}/consortium/crypto-config-ca/ordererOrganizations/amit.com/orderers/orderer.amit.com/msp/config.yaml
  ...
  cp ${PWD}/consortium/crypto-config-ca/ordererOrganizations/amit.com/orderers/orderer.amit.com/tls/keystore/* ${PWD}/consortium/crypto-config-ca/ordererOrganizations/amit.com/orderers/orderer1.amit.com/tls/server.key

  mkdir ${PWD}/consortium/crypto-config-ca/ordererOrganizations/amit.com/orderers/orderer1.amit.com/msp/tlscacerts
...
orderer2MSP() {
  ...
  mkdir ${PWD}/consortium/crypto-config-ca/ordererOrganizations/amit.com/orderers/orderer2.amit.com/msp/tlscacerts
